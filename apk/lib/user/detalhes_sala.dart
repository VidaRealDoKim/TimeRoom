...
class _HomePageState extends State<HomePage> {
  ...
  List<Map<String, dynamic>> salas = []; // Todas as salas
  List<Map<String, dynamic>> filteredSalas = []; // Salas após filtros aplicados
  ...
  void initState() {
    super.initState();
    fetchSalasDisponiveis(); // Carrega as salas ao iniciar a página
  }
  ...
  Future<void> applyFilters() async {
    ...
    // Checa se a sala está ocupada na data selecionada
    if (dataReserva != null) {
      ...
      for (var sala in tempFiltered) {
        ...
        reserva['sala_id'] == sala['id'] && reserva['status'] != 'cancelada');
...
class DetalhesSalaPage extends StatelessWidget {
  ...
  /// Abre a página de NovaReservaPage
  /// A confirmação de reserva será feita dentro de NovaReservaPage
  void _reservarSala(BuildContext context) async {
    ...
    // Não precisa abrir ConfirmacaoReservaPage aqui
  }
