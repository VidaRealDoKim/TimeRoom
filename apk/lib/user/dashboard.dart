...
class _DashboardPageState extends State<DashboardPage> {
      ...
      MaterialPageRoute(
        builder: (_) => QRViewPage(
          onScan: (String salaId) async {
            ...
            final salaResponse = await supabase.from('salas').select().eq('id', salaId).maybeSingle();
  ...
  Widget build(BuildContext context) {
    // Guardamos o tema atual numa variável para facilitar o acesso.
              ...
              DrawerHeader(
                ...
                child: Column(
                  ...
                  children: [
                    CircleAvatar(
                      radius: 30,
                      backgroundColor: theme.colorScheme.onPrimary, // Fundo branco
  ...
  Widget _buildNavItem(IconData icon, int index) {
    ...
    // As cores agora são definidas com base no brilho do tema.
    final color = isSelected
        ? (theme.brightness == Brightness.dark ? theme.colorScheme.primary : Colors.white)
        : (theme.brightness == Brightness.dark ? Colors.grey[400] : Colors.white.withOpacity(0.7));
...
// O widget QRViewPage permanece o mesmo.
